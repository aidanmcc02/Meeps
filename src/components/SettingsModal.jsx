                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        await invoke("set_launch_at_startup", {
                          enabled: next,
                        });
              ...
              <li>
                <div className="flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-gray-700 dark:text-gray-200">
                  ...
                  <button
                    ...
                    onClick={() =>
                      onGamingOverlayChange?.(!gamingOverlayEnabled)
                    }
              ...
              <li>
                <div className="flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-gray-700 dark:text-gray-200">
                  ...
                  <button
                    ...
                    onClick={() =>
                      onActivityLoggingChange?.(!activityLoggingEnabled)
                    }
                    className={`relative inline-flex h-6 w-11 flex-shrink-0 rounded-full border-2 border-transparent transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 ${
                      activityLoggingEnabled
                        ? "bg-indigo-600"
              ...
              <li>
                <div className="flex w-full flex-col gap-2 rounded-lg px-3 py-2.5 text-left text-sm text-gray-700 dark:text-gray-200">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 -mt-0.5 ml-8">
                    How much of your activity others see when activity logging
                    is on.
                  </p>
                  <select
                    value={activityDetailLevel ?? "in_depth"}
                    onChange={(e) =>
                      onActivityDetailLevelChange?.(e.target.value)
                    }
        ...
        {view === "keybinds" && (
          <div className="space-y-5">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Toggle: press to mute, press again to unmute. Hold: hold key to
              mute, release to unmute. Only active when in a call.
            </p>
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                >
                  {capturing === "mute"
                    ? "Press a key…"
                    : formatKeyLabel(localKeybinds.mute?.key)}
                </button>
                <select
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                >
                  {capturing === "muteDeafen"
                    ? "Press a key…"
                    : formatKeyLabel(localKeybinds.muteDeafen?.key)}
                </button>
                <select
